...
/******/ 	return __webpack_require__(__webpack_require__.s = "./test/curves_hermit.ts");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _src_display_canvas2d_display__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../src/display/canvas2d_display */ \"./src/display/canvas2d_display.ts\");\n/* harmony import */ var _src_math_scalar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../src/math/scalar */ \"./src/math/scalar.ts\");\n\r\n\r\n// Hermit\r\nlet v0 = 0, t0 = 8.728395, f0 = 0.0;\r\nlet v1 = 1, t1 = 0, f1 = 0.2517014;\r\nfunction hermiteTest(x) {\r\n    return _src_math_scalar__WEBPACK_IMPORTED_MODULE_1__[/* FloatScalar */ \"a\"].Hermite(v0, t0 * (f1 - f0), v1, t1 * (f1 - f0), x);\r\n}\r\nlet canvas = document.createElement('canvas');\r\ndocument.body.appendChild(canvas);\r\ncanvas.width = 500;\r\ncanvas.height = 1000;\r\nlet ctx = canvas.getContext('2d');\r\nctx.fillStyle = '#0f0';\r\nctx.fillRect(0, canvas.height - 500, canvas.width, 1);\r\nfor (let i = 0; i < 500; i++) {\r\n    let x = i / 500;\r\n    let v = hermiteTest(x);\r\n    Object(_src_display_canvas2d_display__WEBPACK_IMPORTED_MODULE_0__[/* canvas2DDisplay */ \"a\"])(ctx, x * canvas.width, canvas.height - v * 500, '#f00');\r\n}\r\n\n\n//# sourceURL=webpack:///./test/curves_hermit.ts?");
