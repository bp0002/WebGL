...
Shader "Pi/PBR"
{
	Properties
	{
		_Color("Color", Color) = (100,100,100,100)
		_MainTex("Albedo", 2D) = "white" {}

		[HideInInspector] _Cutoff("Alpha Cutoff", Range(0.0, 1.0)) = 0.4

		_Glossiness("Smoothness", Range(0.0, 1.0)) = 0.5
		[HideInInspector] _GlossMapScale("Smoothness Scale", Range(0.0, 1.0)) = 0.5
		[HideInInspector] [Enum(Metallic Alpha,0,Albedo Alpha,1)] _SmoothnessTextureChannel("Smoothness texture channel", Float) = 0
		...
		[HideInInspector] _OcclusionMap("Occlusion", 2D) = "black" {}

		[HideInInspector] _EmissionColor("EmissionColor", Color) = (0,0,0)
		[HideInInspector] _EmissionMap("Emission", 2D) = "black" {}

		[HideInInspector] _DetailMask("Detail Mask", 2D) = "black" {}

		[HideInInspector] _DetailAlbedoMap("Detail Albedo x2", 2D) = "black" {}
		[HideInInspector] _DetailNormalMapScale("Scale", Float) = 1.0
		[HideInInspector] _DetailNormalMap("Normal Map", 2D) = "black" {}
