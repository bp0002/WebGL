...
coordinate_sys.eulerAnglesToQuaternion(30 / 180 * Math.PI, 60 / 180 * Math.PI, 90 / 180 * Math.PI, decomposeQuaternion);
...
coordinate_sys.eulerAnglesToQuaternion(135 / 180 * Math.PI, 0 / 180 * Math.PI, 0 / 180 * Math.PI, invertQuaternion);
...
display('欧拉角四元数变换<br>');
let eulerToQuaternion_euler = new Vector3(1.5, Math.PI, Math.PI);
let eulerToQuaternion_quaternion = new Quaternion();
display(`初始欧拉角:<br>`);
display(eulerToQuaternion_euler.toFormatString(undefined, undefined, '<br>'));
coordinate_sys.eulerAnglesToQuaternion(eulerToQuaternion_euler.x, eulerToQuaternion_euler.y, eulerToQuaternion_euler.z, eulerToQuaternion_quaternion);
display(`转换为四元数:<br>`);
display(eulerToQuaternion_quaternion.toFormatString(undefined, undefined, '<br>'));
display(`转换回欧拉角:<br>`);
coordinate_sys.quaternionToEulerAngles(eulerToQuaternion_quaternion, eulerToQuaternion_euler);
display(eulerToQuaternion_euler.toFormatString(undefined, undefined, '<br>'));
